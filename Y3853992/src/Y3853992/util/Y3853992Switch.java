 ...
 * @generated
 */
public class Y3853992Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Y3853992Package.TEAM_MEMBER: {
