 ...
 * @generated
 */
public class TestCaseVerifiesCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TestCaseVerifiesCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof TestCase) {
			return false;
		}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getVerifies().add(getTarget());
		}
