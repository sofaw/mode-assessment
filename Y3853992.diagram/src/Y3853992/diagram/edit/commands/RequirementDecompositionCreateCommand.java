 ...
 * @generated
 */
public class RequirementDecompositionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RequirementDecompositionCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDecomposition().add(getTarget());
		}
