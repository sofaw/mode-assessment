 ...
 * @generated
 */
public class RequirementConflictsCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RequirementConflictsCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return Y3853992BaseItemSemanticEditPolicy.getLinkConstraints().canCreateRequirementConflicts_4007(getSource(),
				getTarget());
	}
