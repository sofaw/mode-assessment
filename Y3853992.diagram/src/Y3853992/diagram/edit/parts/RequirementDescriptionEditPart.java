 ...
 * @generated
 */
public class RequirementDescriptionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RequirementDescriptionEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = Y3853992ParserProvider.getParser(Y3853992ElementTypes.Requirement_2001, getParserElement(),
					Y3853992VisualIDRegistry
							.getType(Y3853992.diagram.edit.parts.RequirementDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
