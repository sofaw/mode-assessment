 ...
 * @generated
 */
public class RequirementIdentifierEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RequirementIdentifierEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = Y3853992ParserProvider.getParser(Y3853992ElementTypes.Requirement_2001, getParserElement(),
					Y3853992VisualIDRegistry
							.getType(Y3853992.diagram.edit.parts.RequirementIdentifierEditPart.VISUAL_ID));
		}
		return parser;
	}
