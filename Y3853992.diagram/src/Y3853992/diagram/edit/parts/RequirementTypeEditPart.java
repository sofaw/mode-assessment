 ...
 * @generated
 */
public class RequirementTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, Y3853992EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
