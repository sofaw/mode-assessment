...
import Y3853992.diagram.edit.policies.Y3853992TextSelectionEditPolicy;
 ...
 * @generated
 */
public class RequirementDescription2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RequirementDescription2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new Y3853992TextSelectionEditPolicy());
		...
		if (parser == null) {
			parser = Y3853992ParserProvider.getParser(Y3853992ElementTypes.Requirement_2007, getParserElement(),
					Y3853992VisualIDRegistry
							.getType(Y3853992.diagram.edit.parts.RequirementDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, Y3853992EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
