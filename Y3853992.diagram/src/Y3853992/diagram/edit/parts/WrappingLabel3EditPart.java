...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				Y3853992VisualIDRegistry.getType(Y3853992.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = Y3853992ParserProvider.getParser(Y3853992ElementTypes.TeamMemberRequirements_4004,
