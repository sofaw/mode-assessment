 ...
 * @generated
 */
public class TestCaseItemSemanticEditPolicy extends Y3853992BaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Y3853992VisualIDRegistry.getVisualID(outgoingLink) == TestCaseVerifiesEditPart.VISUAL_ID) {
