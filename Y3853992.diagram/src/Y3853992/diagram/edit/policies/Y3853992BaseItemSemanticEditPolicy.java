 ...
 * @generated
 */
public class Y3853992BaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected Y3853992BaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(Y3853992VisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = Y3853992ElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = Y3853992DiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			Y3853992DiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		...
		public boolean canCreateRequirementDecomposition_4001(Requirement source, Requirement target) {
			...
			if (target != null && (target.getParentDecomposition().contains(target))) {
				return false;
			}
		...
		/**
			* @generated
			*/
		public boolean canCreateRequirementTeamMembers_4005(Requirement source, TeamMember target) {
			if (source != null) {
				if (source.getTeamMembers().contains(target)) {
					return false;
				}
			}
			if (target != null && (target.getRequirements().contains(target))) {
				return false;
			}

			return canExistRequirementTeamMembers_4005(source, target);
		}
		...
		public boolean canCreateTestCaseVerifies_4004(TestCase source, Requirement target) {
			...
			if (target != null && (target.getTestCases().contains(target))) {
				return false;
			}
		...
		*/
		...
		/**
			* @generated
			*/
		public boolean canExistRequirementTeamMembers_4005(Requirement source, TeamMember target) {
			return true;
		}
