 ...
 * @generated
 */
public class Y3853992ViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return RequirementsModelEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& Y3853992VisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = Y3853992VisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = Y3853992VisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!Y3853992ElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
				...
				if (!RequirementsModelEditPart.MODEL_ID
						.equals(Y3853992VisualIDRegistry.getModelID(op.getContainerView()))) {
				...
				case TeamMemberEditPart.VISUAL_ID:
					if (domainElement == null || visualID != Y3853992VisualIDRegistry
		...
		return RequirementEditPart.VISUAL_ID == visualID || TestCaseEditPart.VISUAL_ID == visualID
				|| TeamMemberEditPart.VISUAL_ID == visualID;
	}
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = Y3853992VisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != Y3853992VisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(RequirementsModelEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = Y3853992VisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = Y3853992VisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case RequirementEditPart.VISUAL_ID:
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case RequirementTeamMembersEditPart.VISUAL_ID:
			return createRequirementTeamMembers_4005(containerView, index, persisted, preferencesHint);
	...
	*/
	public Node createRequirement_2007(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(Y3853992VisualIDRegistry.getType(RequirementEditPart.VISUAL_ID));
	...
	*/
	public Node createTestCase_2008(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Y3853992VisualIDRegistry.getType(TestCaseEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	*/
	public Node createTeamMember_2009(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(Y3853992VisualIDRegistry.getType(TeamMemberEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	*/
	public Edge createConflict_4008(EObject domainElement, View containerView, int index, boolean persisted,
		...
		edge.setType(Y3853992VisualIDRegistry.getType(ConflictEditPart.VISUAL_ID));
	...
	*/
	public Edge createRequirementDecomposition_4001(View containerView, int index, boolean persisted,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(Y3853992VisualIDRegistry.getType(RequirementDecompositionEditPart.VISUAL_ID));
		...
		Node label6001 = createLabel(edge, Y3853992VisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createRequirementTeamMembers_4005(View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(Y3853992VisualIDRegistry.getType(RequirementTeamMembersEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label6005 = createLabel(edge, Y3853992VisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	...
	*/
	public Edge createTestCaseVerifies_4004(View containerView, int index, boolean persisted,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(Y3853992VisualIDRegistry.getType(TestCaseVerifiesEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
		...
		Node label6004 = createLabel(edge, Y3853992VisualIDRegistry.getType(WrappingLabel3EditPart.VISUAL_ID));
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!RequirementsModelEditPart.MODEL_ID.equals(Y3853992VisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", RequirementsModelEditPart.MODEL_ID); //$NON-NLS-1$
