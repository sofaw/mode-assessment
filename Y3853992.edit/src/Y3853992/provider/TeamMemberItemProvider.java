...
/**
 * This is the item provider adapter for a {@link Y3853992.TeamMember} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TeamMemberItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TeamMember_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TeamMember_name_feature", "_UI_TeamMember_type"),
				 Y3853992Package.Literals.TEAM_MEMBER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRequirementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TeamMember_requirements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TeamMember_requirements_feature", "_UI_TeamMember_type"),
				 Y3853992Package.Literals.TEAM_MEMBER__REQUIREMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TeamMember.class)) {
			case Y3853992Package.TEAM_MEMBER__NAME:
