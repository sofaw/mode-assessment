...
/**
 * This is the item provider adapter for a {@link Y3853992.Conflict} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConflictItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_first_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_first_feature", "_UI_Conflict_type"),
				 Y3853992Package.Literals.CONFLICT__FIRST,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSecondPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_second_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_second_feature", "_UI_Conflict_type"),
				 Y3853992Package.Literals.CONFLICT__SECOND,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Conflict_type");
	}
